 ...
 #include "TAttLine.h"
  ...
  void BR_1GeV() {  
     ...
     //2 sigma band
     double y3[4] = {25.5675818688838,53.1579311964832,1209.80203214832,153034.033792049}; 
     double ex3[4] = {0., 0., 0., 0.};
     double ey3[4] = {14.4933190867737,29.6837345198777,672.787412729358,101198.481192661};
     ...
     sigma2->GetYaxis()->SetRangeUser(10,150000);
     //sigma2->GetYaxis()->SetRangeUser(-10,195585);
     sigma2->SetTitle(" ");
     sigma2->Draw("a3");
     
     //1 sigma band
     double y4[4] = {21.2888305798930,45.1665494396024,1041.27656120031,106695.439315749};
     double ex4[4] = {0., 0., 0., 0.};
     double ey4[4] = {7.49644554396024,15.4468867974006,343.987672974006,43434.6020986239};
     ...
     //observed
     double y1[4] = {26.1984036697248,56.4103773700306,1281.33821865443,128482.620795107}; //value
     double ex1[4] = {0., 0., 0., 0.};
     double ey1[4] = {0.217817906727829,0.453163112385321,10.1650759174312,1950.93442660550}; //error
     ...
     //expected (median)
     double y2[4] = {19.8638241590214,42.4941552752294,937.236773700306,92293.6628440367}; //value
     double ex2[4] = {0., 0., 0., 0.};
     double ey2[4] = {0.209220715596330,0.458779935779816,10.6766680428135,881.435053516820}; //error
     ...
     //unphysical area
     double y5[4] = {128000,128000,128000,128000}; 
     double ex5[4] = {0., 0., 0., 0.};
     double ey5[4] = {127999,127999,127999,127999};
