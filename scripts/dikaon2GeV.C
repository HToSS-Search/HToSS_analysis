 ...
 #include "TPRegexp.h"
  ...
  void dikaon2GeV() {  
     ...
     TH1F* h_antiscalarInvMass_ctau0    = (TH1F*)inFile0.Get("h_TestKantiscalarInvMass");
     
     TFile inFile10("ggH_MS2_ctau10.root"); 
     TH1F* h_antiscalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_TestKantiscalarInvMass");
     ...
     canv1->SaveAs("h_dikaon2GeV.png"); // .pdf and other formats work too! 
