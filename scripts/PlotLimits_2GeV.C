#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void PlotLimits_2GeV() {  
     ...
     double x1[] = {0, 1, 10};
     double y1[] = {0, 0.0479211, 0.477744}; //value
     double ex1[] = {0., 0., 0.};
     double ey1[] = {0., 0.00871479, 0.00552663 }; //error
     ...
     double y2[] = {0, 0.0383966, 0.383998}; //value
     double ex2[] = {0., 0., 0.};
     double ey2[] = {0, 0.000545785, 0.00417906}; //error
