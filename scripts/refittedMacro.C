 ...
 #include "TPRegexp.h"
  ...
  void refittedMacro() {  
     ...
     h_refit12InvMass_ctau0->GetYaxis()->SetRangeUser(0.001, 100000.); 
     ...
     h_refit12InvMass_ctau10->GetYaxis()->SetRangeUser(0.001, 100000.); 
     ...
     h_refit12InvMass_QCD->GetXaxis()->SetRangeUser(0.001, 5.); 
