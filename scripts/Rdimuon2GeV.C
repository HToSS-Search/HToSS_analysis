#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void Rdimuon2GeV() {  
     ...
     h_scalarInvMass_ctau0->GetXaxis()->SetRangeUser(0,5);  
     ...
     h_scalarInvMass_ctau10->GetXaxis()->SetRangeUser(0,5); 
     ...
     h_scalarInvMass_QCD->GetXaxis()->SetRangeUser(0,5); 
     ...
     h_scalarInvMass_data->GetXaxis()->SetRangeUser(0,5); 
