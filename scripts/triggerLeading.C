#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void triggerLeading() {  
     ...
     h_pt_ctau0->GetYaxis()->SetRangeUser(1.0,12000); 
     ...
     h_ptcut_ctau0->GetYaxis()->SetRangeUser(1.0,12000); 
     ...
     h_ptcut2_ctau0->GetYaxis()->SetRangeUser(1.0,12000); 
     ...
     canv1->SaveAs("triggerLeading.pdf"); // .pdf and other formats work too! 
