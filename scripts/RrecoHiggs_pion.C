#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void RrecoHiggs_pion() {  
  
     TFile inFile0("ggH_MS1_ctau0.root"); 
     TH1F* h_higgsInvMass_ctau0    = (TH1F*)inFile0.Get("h_RTestPhiggsInvMass");
     
     TFile inFile10("ggH_MS1_ctau10.root"); 
     TH1F* h_higgsInvMass_ctau10    = (TH1F*)inFile10.Get("h_RTestPhiggsInvMass");
    ...
    // h_higgsInvMass_ctau0->GetYaxis()->SetRangeUser(0,65000); 
    ...
    // h_higgsInvMass_ctau10->GetYaxis()->SetRangeUser(0,65000); 
     ...
     canv1->SaveAs("h_RrecoHiggs_pion.png"); // .pdf and other formats work too! 
