#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void Rdikaon2GeV() {  
     ...
     TH1F* h_scalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_RTestKantiscalarInvMass");
 
     TFile inFileQCD("ggH_MC_QCD.root"); 
     TH1F* h_scalarInvMass_QCD    = (TH1F*)inFileQCD.Get("h_RTestKantiscalarInvMass");
       
     TFile inFileData("dataRunD_2GeV20.root"); 
     TH1F* h_scalarInvMass_data    = (TH1F*)inFileData.Get("h_RTestKantiscalarInvMass");
     ...
     h_scalarInvMass_ctau0->GetYaxis()->SetRangeUser(0.01, 10000.);
     h_scalarInvMass_ctau0->SetTitle("");
     h_scalarInvMass_ctau0->GetYaxis()->SetTitle("Events");
     h_scalarInvMass_ctau0->GetXaxis()->SetRangeUser(1,4);  
     h_scalarInvMass_ctau0->GetXaxis()->SetTitle("m_{KK} (GeV)");
     ...
     h_scalarInvMass_ctau10->GetXaxis()->SetRangeUser(1,4); 
     h_scalarInvMass_ctau10->GetXaxis()->SetTitle("m_{KK} (GeV)");
     ...
     h_scalarInvMass_QCD->GetXaxis()->SetRangeUser(1,4); 
     h_scalarInvMass_QCD->GetXaxis()->SetTitle("m_{KK} (GeV)");
     ...
     h_scalarInvMass_data->GetXaxis()->SetRangeUser(1,4); 
     h_scalarInvMass_data->GetXaxis()->SetTitle("m_{KK} (GeV)");
     ...
     canv1->SaveAs("h_Rdikaon2GeV.pdf"); // .pdf and other formats work too! 
