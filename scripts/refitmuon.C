 ...
 #include "TPRegexp.h"
  ...
  void refitmuon() {  
   ...
   /*
     ...
     h_PscalarInvMass_ctau0->GetXaxis()->SetRangeUser(0,20); 
     ...
     h_PscalarInvMass_ctau10->GetXaxis()->SetRangeUser(0,20); 
   ...
   std:cout<<"Not refit "<<h_PscalarInvMass_ctau10->GetBinContent(501)<<std::endl;
   
     h_PscalarInvMass_QCD->GetYaxis()->SetTitle("Events");
     h_PscalarInvMass_QCD->GetXaxis()->SetRangeUser(0,20); 
     ...
     h_PscalarInvMass_data->GetXaxis()->SetRangeUser(0,20); 
     ...
     h_refit12InvMass_ctau0->GetXaxis()->SetRangeUser(0,20); 
     ...
     h_refit12InvMass_ctau10->GetXaxis()->SetRangeUser(0,20); 
     ...
     std::cout<<"Refit "<<h_refit12InvMass_ctau10->GetBinContent(501)<<std::endl;

     h_refit12InvMass_QCD->GetYaxis()->SetTitle("Events");
     h_refit12InvMass_QCD->GetXaxis()->SetRangeUser(0,20); 
     ...
     h_refit12InvMass_data->GetXaxis()->SetRangeUser(0,20); 
