#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void refitmuon() {  
     ...
     TH1F* h_PscalarInvMass_ctau0    = (TH1F*)inFile0.Get("h_K20antiscalarInvMass");

     TFile inFile10("ggH_MS2_ctau10.root"); 
     TH1F* h_refit12InvMass_ctau10    = (TH1F*)inFile10.Get("h_Rrefit12InvMass");
     TH1F* h_PscalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_K20antiscalarInvMass");

     TFile inFileQCD("ggH_MC_QCD.root"); 
     TH1F* h_refit12InvMass_QCD    = (TH1F*)inFileQCD.Get("h_Rrefit12InvMass");
     TH1F* h_PscalarInvMass_QCD    = (TH1F*)inFileQCD.Get("h_K20antiscalarInvMass");
     ...
     TH1F* h_PscalarInvMass_data    = (TH1F*)inFileData.Get("h_K20antiscalarInvMass");
