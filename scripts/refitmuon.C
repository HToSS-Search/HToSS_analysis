#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void refitmuon() {  
     ...
     TH1F* h_PscalarInvMass_data    = (TH1F*)inFileData.Get("h_pNentries");
    ...
    // canv1->SetLogy();
     ...
     //h_PscalarInvMass_ctau0->SetTitle("Refitted dihadron (kaons) invariant mass");
