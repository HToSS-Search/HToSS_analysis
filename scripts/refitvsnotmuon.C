#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void refitvsnotmuon() {  
     ...
     TH1F* h_P20scalarInvMass_ctau0    = (TH1F*)inFile0.Get("h_P20higgsInvMass");
    // TH1F* h_PantiscalarInvMass_ctau0    = (TH1F*)inFile0.Get("h_PantiscalarInvMass");
     ...
     TH1F* h_P20scalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_P20higgsInvMass");
   ...
   //  TH1F* h_PantiscalarInvMass_QCD    = (TH1F*)inFileQCD.Get("h_PantiscalarInvMass");
     ...
     TH1F* h_scalescalarInvMass_QCD    = (TH1F*)inFileQCD.Get("h_P20higgsInvMass");
  ...
  // h_genParScalarMuonDivPtSL=(TH1F*)h_genParScalarMuonCutPtSL->Clone(
    ...
    // h_refit12InvMass_QCD->GetYaxis()->SetRangeUser(1.0, 65000.); 
     ...
     h_scalescalarInvMass_QCD->SetTitle("Higgs invariant mass, wider Higgs window");
     h_scalescalarInvMass_QCD->GetYaxis()->SetRangeUser(1.0, 8000.); 
     h_scalescalarInvMass_QCD->GetYaxis()->SetTitle("Events");
     h_scalescalarInvMass_QCD->GetXaxis()->SetRangeUser(100, 150.); 
     h_scalescalarInvMass_QCD->GetXaxis()->SetTitle("m_{Higgs} (GeV/c^{2})");
     ...
     h_P20scalarInvMass_ctau0->GetXaxis()->SetRangeUser(100, 150.); 
     h_P20scalarInvMass_ctau0->GetXaxis()->SetTitle("m_{Higgs} (GeV/c^{2})");
     ...
     h_P20scalarInvMass_ctau10->GetXaxis()->SetRangeUser(100, 150.); 
     h_P20scalarInvMass_ctau10->GetXaxis()->SetTitle("m_{Higgs} (GeV/c^{2})");
