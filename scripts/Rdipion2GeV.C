#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void Rdipion2GeV() {  
     ...
     TH1F* h_antiscalarInvMass_ctau0    = (TH1F*)inFile0.Get("h_RTestPantiscalarInvMass");
     
     TFile inFile10("ggH_MS2_ctau10.root"); 
     TH1F* h_antiscalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_RTestPantiscalarInvMass");
     ...
     h_antiscalarInvMass_ctau0->GetXaxis()->SetRangeUser(0,4);  
     ...
     h_antiscalarInvMass_ctau10->GetXaxis()->SetRangeUser(0,4); 
     ...
     canv1->SaveAs("h_Rdipion2GeV.png"); // .pdf and other formats work too! 
