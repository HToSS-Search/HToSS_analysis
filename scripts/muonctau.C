 ...
 #include "TPRegexp.h"
  ...
  void muonctau() {  
    ...
    // h_refit12InvMass_ctau1->GetYaxis()->SetRangeUser(1.0, 10000.); 
     h_PscalarInvMass_ctau1->GetXaxis()->SetRangeUser(0.5, 4.); 
   ...
   //  h_refit12InvMass_ctau1000->GetYaxis()->SetRangeUser(1.0, 10000.); 
     h_PscalarInvMass_ctau1000->GetXaxis()->SetRangeUser(0.5, 4.); 
     h_PscalarInvMass_ctau1000->GetXaxis()->SetTitle("m_{#mu#mu} (GeV/c^{2})");
     h_PscalarInvMass_ctau1000->SetMarkerColor(3);
     h_PscalarInvMass_ctau1000->SetLineColor(3);
