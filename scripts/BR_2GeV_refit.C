#include "TFile.h"
 ...
 #include "TAttLine.h"
  ...
  void BR_2GeV_refit() {  
     ...
     //2 sigma band
     double y3[4] = {0.121268964205021,0.149201310358637,0.835307111177525,59.3253646861925}; 
     double ex3[4] = {0., 0., 0., 0.};
     double ey3[4] = {0.0673134395965332,0.0834648683323371,0.473437862402869,36.8154352002391};
     ...
     //1 sigma band
     double y4[4] = {0.102370653705918,0.124491825313808,0.704154725732218,47.6109118221757};
     double ex4[4] = {0., 0., 0., 0.};
     double ey4[4] = {0.0418505250747161,0.0512111855648536,0.256074708398087,18.1009969524806};
     ...
     //observed
     double y1[4] = {0.0756888039450090,0.0904358051404662,0.497574429169157,32.4617967722654}; //value
     double ex1[4] = {0., 0., 0., 0.};
     double ey1[4] = {0.0160785928272564,0.0197233895397490,0.00605360496114764,0.426726066945607}; //error
     ...
     //expected (median)
     double y2[4] = {0.0925609210998207,0.111837930663479,0.660867525403467,42.5708463837418}; //value
     double ex2[4] = {0., 0., 0., 0.};
     double ey2[4] = {0.0202765791990436,0.0256856678421996,0.00706345367603108,0.357845929468022}; //error
     ...
     //unphysical area
     double y5[4] = {101,101,101,101}; 
     double ex5[4] = {0., 0., 0., 0.};
     double ey5[4] = {100,100,100,100};
