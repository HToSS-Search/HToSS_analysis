#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void RelIso_T() {  
     ...
     TLegendEntry *legenda = legend1->AddEntry("h_PIsoSum1_ctau10","Leading","L");
     legenda->SetLineColor(4);
     legenda->SetMarkerColor(4);
     legenda->SetMarkerSize(2);
     legenda=legend1->AddEntry("h_PIsoSum2_ctau10","Subleading","L");
     ...
     canv1->SaveAs("h_PRelIso.png"); // .pdf and other formats work too! 
     ...
     h_KIsoSum2_ctau10->SetMarkerColor(2);
     h_KIsoSum2_ctau10->SetLineColor(2);
     h_KIsoSum2_ctau10->Draw("HIST same");
   
     TLegend *legend2 = new TLegend(0.7,0.7,0.9,0.9);
     legend2->SetBorderSize(1);
     TLegendEntry *legendb = legend2->AddEntry("h_KIsoSum1_ctau10","Leading","L");
     legendb->SetLineColor(4);
     legendb->SetMarkerColor(4);
     legendb->SetMarkerSize(2);
     legendb=legend2->AddEntry("h_KIsoSum2_ctau10","Subleading","L");
     ...
     // save canvas with drawn histogram
     canv2->SaveAs("h_KRelIso.png"); // .pdf and other formats work too! 
     ...
     TLegendEntry *legendc = legend3->AddEntry("h_MuonIsoSum1_ctau10","Leading","L");
     legendc->SetLineColor(4);
     legendc->SetMarkerColor(4);
     legendc->SetMarkerSize(2);
     legendc=legend3->AddEntry("h_MuonIsoSum2_ctau10","Subleading","L");
     ...
     // save canvas with drawn histogram
     canv3->SaveAs("h_MuonRelIso.png"); // .pdf and other formats work too! 
