 ...
 #include "TPRegexp.h"
  ...
  void efficiency_DL() {  
     ...
     TH1F* h_ptdiv_ctau1    = (TH1F*)inFile1.Get("h_genParScalarMuonCutPtDL;2");
     ...
     TH1F* h_ptdiv_ctau1000    = (TH1F*)inFile1000.Get("h_genParScalarMuonCutPtDL;2");
     ...
     canv1->SaveAs("efficiency_DL.pdf"); // .pdf and other formats work too! 
