//An example macro for manipulating 2D plots
 ...
 #include "TLatex.h"
  ...
  void examplePlot2DMacro() {  
     ...
     TFile inFile("ggH_MS2_ctau1_GEN.root"); // read in file. Exercise: can this be done through a command line arguement? That way you don't have to edit code for each new histogram ...
