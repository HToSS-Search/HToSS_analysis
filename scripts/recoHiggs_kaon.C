#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void recoHiggs_kaon() {  
     ...
     TH1F* h_scalarInvMass_ctau0    = (TH1F*)inFile0.Get("h_TestKhiggsInvMass");
     
     TFile inFile10("ggH_MS2_ctau10.root"); 
     TH1F* h_scalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_TestKhiggsInvMass");
     ...
     h_higgsInvMass_ctau0->GetXaxis()->SetRangeUser(100,150);  
     ...
     canv1->SaveAs("h_recoHiggs_kaon.png"); // .pdf and other formats work too! 
