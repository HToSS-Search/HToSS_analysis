#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void recoHiggs_kaon() {  
     ...
     TH1F* h_higgsInvMass_ctau10    = (TH1F*)inFile10.Get("h_TestKhiggsInvMass");
     ...
     TLegendEntry *legenda = legend1->AddEntry("h_higgsInvMass_ctau0","c#tau = 0 mm","L");
     legenda->SetLineColor(4);
     legenda->SetMarkerColor(4);
     legenda->SetMarkerSize(2);
     legenda=legend1->AddEntry("h_higgsInvMass_ctau10","c#tau = 10 mm","L");
     ...
     canv1->SaveAs("h_recoHiggs_kaon.pdf"); // .pdf and other formats work too! 
