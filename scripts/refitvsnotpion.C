#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void refitvsnotpion() {  
     ...
     h_refit12InvMass_ctau0->SetTitle("Dihadron (pion) invariant mass with(out) refit");
     ...
     h_refit12InvMass_ctau0->GetXaxis()->SetTitle("m_{#pi#pi} (GeV/c^{2})");
     ...
     h_refit12InvMass_ctau10->GetXaxis()->SetTitle("m_{#pi#pi} (GeV/c^{2})");
     ...
     h_refit12InvMass_QCD->GetXaxis()->SetTitle("m_{#pi#pi} (GeV/c^{2})");
   ...
   /*
     ...
     h_PantiscalarInvMass_ctau0->GetXaxis()->SetRangeUser(0.0, 5.); 
     h_PantiscalarInvMass_ctau0->GetXaxis()->SetTitle("m_{#pi#pi} (GeV/c^{2})");
     ...
     h_PantiscalarInvMass_ctau10->GetXaxis()->SetRangeUser(0.0, 5.); 
     h_PantiscalarInvMass_ctau10->GetXaxis()->SetTitle("m_{#pi#pi} (GeV/c^{2})");
     ...
     h_PantiscalarInvMass_QCD->GetXaxis()->SetRangeUser(0.0, 5.); 
     h_PantiscalarInvMass_QCD->GetXaxis()->SetTitle("m_{#pi#pi} (GeV/c^{2})");
