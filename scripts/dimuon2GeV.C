 ...
 #include "TPRegexp.h"
  ...
  void dimuon2GeV() {  
     ...
     TH1F* h_scalarInvMass_ctau10    = (TH1F*)inFile10.Get("h_TestscalarInvMass");
     ...
     h_scalarInvMass_ctau0->GetYaxis()->SetRangeUser(0.01,1000);  
     ...
     h_scalarInvMass_ctau10->GetYaxis()->SetRangeUser(0.01,1000);  
     ...
     canv1->SaveAs("h_dimuon2GeV.pdf"); // .pdf and other formats work too! 
