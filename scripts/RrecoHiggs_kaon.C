#include "TFile.h"
 ...
 #include "TPRegexp.h"
  ...
  void RrecoHiggs_kaon() {  
     ...
     h_higgsInvMass_ctau0->GetYaxis()->SetRangeUser(0.01,1000);
     ...
     h_higgsInvMass_ctau10->GetYaxis()->SetRangeUser(0.01,1000);
     ...
     h_higgsInvMass_QCD->GetYaxis()->SetRangeUser(0.01,1000);
     ...
     h_higgsInvMass_data->GetYaxis()->SetRangeUser(0.01,1000);
