...
*/
    static constexpr size_t NPACKEDCANDSMAX{5000};
...
*/
   ...
   fChain->SetBranchAddress("numVert", &numVert, &b_numVert);
    ...
    fChain->SetBranchStatus("numMuonPF2PAT",1);
    fChain->SetBranchStatus("muonPF2PATE",1);
    fChain->SetBranchStatus("muonPF2PATET",1);
    fChain->SetBranchStatus("muonPF2PATPt",1);
    fChain->SetBranchStatus("muonPF2PATPX",1);
    fChain->SetBranchStatus("muonPF2PATPY",1);
    fChain->SetBranchStatus("muonPF2PATPZ",1);
    fChain->SetBranchStatus("muonPF2PATPhi",1);
    fChain->SetBranchStatus("muonPF2PATTheta",1);
    fChain->SetBranchStatus("muonPF2PATEta",1);
    fChain->SetBranchStatus("muonPF2PATCharge",1);
    fChain->SetBranchStatus("muonPF2PATLooseCutId",1);
    fChain->SetBranchStatus("muonPF2PATMediumCutId",1);
    fChain->SetBranchStatus("muonPF2PATTightCutId",1);
    fChain->SetBranchStatus("muonPF2PATPfIsoVeryLoose",1);
    fChain->SetBranchStatus("muonPF2PATPfIsoLoose",1);
    fChain->SetBranchStatus("muonPF2PATPfIsoMedium",1);
    fChain->SetBranchStatus("muonPF2PATPfIsoTight",1);
    fChain->SetBranchStatus("muonPF2PATPfIsoVeryTight",1);
    fChain->SetBranchStatus("muonPF2PATTkIsoLoose",1);
    fChain->SetBranchStatus("muonPF2PATTkIsoTight",1);
    fChain->SetBranchStatus("muonPF2PATMvaLoose",1);
    fChain->SetBranchStatus("muonPF2PATMvaMedium",1);
    fChain->SetBranchStatus("muonPF2PATMvaTight",1);
    fChain->SetBranchStatus("muonPF2PATGlobalID",1);
    fChain->SetBranchStatus("muonPF2PATTrackID",1);
    fChain->SetBranchStatus("muonPF2PATChi2",1);
    fChain->SetBranchStatus("muonPF2PATD0",1);
    fChain->SetBranchStatus("muonPF2PATTrackDBD0",1);
    fChain->SetBranchStatus("muonPF2PATDBInnerTrackD0",1);
    fChain->SetBranchStatus("muonPF2PATBeamSpotCorrectedD0",1);
    fChain->SetBranchStatus("muonPF2PATTrackNHits",1);
    fChain->SetBranchStatus("muonPF2PATMuonNHits",1);
    fChain->SetBranchStatus("muonPF2PATNDOF",1);
    fChain->SetBranchStatus("muonPF2PATVertX",1);
    fChain->SetBranchStatus("muonPF2PATVertY",1);
    fChain->SetBranchStatus("muonPF2PATVertZ",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkPt",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkPx",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkPy",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkPz",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkEta",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkPhi",1);
    fChain->SetBranchStatus("muonPF2PATChargedHadronIso",1);
    fChain->SetBranchStatus("muonPF2PATNeutralHadronIso",1);
    fChain->SetBranchStatus("muonPF2PATPhotonIso",1);
    fChain->SetBranchStatus("muonPF2PATTrackIso",1);
    fChain->SetBranchStatus("muonPF2PATEcalIso",1);
    fChain->SetBranchStatus("muonPF2PATHcalIso",1);
    fChain->SetBranchStatus("muonPF2PATComRelIso",1);
    fChain->SetBranchStatus("muonPF2PATComRelIsodBeta",1);
    fChain->SetBranchStatus("muonPF2PATChHadIso",1);
    fChain->SetBranchStatus("muonPF2PATNtHadIso",1);
    fChain->SetBranchStatus("muonPF2PATGammaIso",1);
    fChain->SetBranchStatus("muonPF2PATPuIso",1);
    fChain->SetBranchStatus("muonPF2PATIsPFMuon",1);
    fChain->SetBranchStatus("muonPF2PATNChambers",1);
    fChain->SetBranchStatus("muonPF2PATNMatches",1);
    fChain->SetBranchStatus("muonPF2PATTkLysWithMeasurements",1);
    fChain->SetBranchStatus("muonPF2PATGlbTkNormChi2",1);
    fChain->SetBranchStatus("muonPF2PATInnerTkNormChi2",1);
    fChain->SetBranchStatus("muonPF2PATValidFraction",1);
    fChain->SetBranchStatus("muonPF2PATChi2LocalPosition",1);
    fChain->SetBranchStatus("muonPF2PATTrkKick",1);
    fChain->SetBranchStatus("muonPF2PATSegmentCompatibility",1);
    fChain->SetBranchStatus("muonPF2PATDBPV",1);
    fChain->SetBranchStatus("muonPF2PATDBPVError",1);
    fChain->SetBranchStatus("muonPF2PATDZPV",1);
    fChain->SetBranchStatus("muonPF2PATDZPVError",1);
    fChain->SetBranchStatus("muonPF2PATVldPixHits",1);
    fChain->SetBranchStatus("muonPF2PATMatchedStations",1);
    fChain->SetBranchStatus("muonPF2PATImpactTransDist",1);
    fChain->SetBranchStatus("muonPF2PATImpactTransError",1);
    fChain->SetBranchStatus("muonPF2PATImpactTransSignificance",1);
    fChain->SetBranchStatus("muonPF2PATImpact3DDist",1);
    fChain->SetBranchStatus("muonPF2PATImpact3DError",1);
    fChain->SetBranchStatus("muonPF2PATImpact3DSignificance",1);
    fChain->SetBranchStatus("muonPF2PATNumSourceCandidates",1);
    fChain->SetBranchStatus("muonPF2PATPackedCandIndex",1);
    if (isMC) {
        fChain->SetBranchStatus("genMuonPF2PATPT",1);
        fChain->SetBranchStatus("genMuonPF2PATET",1);
        fChain->SetBranchStatus("genMuonPF2PATPX",1);
        fChain->SetBranchStatus("genMuonPF2PATPY",1);
        fChain->SetBranchStatus("genMuonPF2PATPZ",1);
        fChain->SetBranchStatus("genMuonPF2PATPhi",1);
        fChain->SetBranchStatus("genMuonPF2PATTheta",1);
        fChain->SetBranchStatus("genMuonPF2PATEta",1);
        fChain->SetBranchStatus("genMuonPF2PATCharge",1);
        fChain->SetBranchStatus("genMuonPF2PATPdgId",1);
        fChain->SetBranchStatus("genMuonPF2PATMotherId",1);
        fChain->SetBranchStatus("genMuonPF2PATPromptDecayed",1);
        fChain->SetBranchStatus("genMuonPF2PATPromptFinalState",1);
        fChain->SetBranchStatus("genMuonPF2PATHardProcess",1);
        fChain->SetBranchStatus("genMuonPF2PATPythiaSixStatusThree",1);
        fChain->SetBranchStatus("genMuonPF2PATScalarAncestor",1);
        fChain->SetBranchStatus("genMuonPF2PATDirectScalarAncestor",1);
    }
    fChain->SetBranchStatus("numMuonTrackPairsPF2PAT",1);
    fChain->SetBranchStatus("muonTkPairPF2PATIndex1",1);
    fChain->SetBranchStatus("muonTkPairPF2PATIndex2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxPx",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxPy",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxPz",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxP2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVx",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVy",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVz",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov00",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov01",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov02",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov10",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov11",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov12",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov20",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov21",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxCov22",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxChi2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxNdof",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxAngleXY",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxDistMagXY",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxDistMagXYSigma",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxAngleXYZ",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxDistMagXYZ",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxDistMagXYZSigma",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Pt",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Px",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Py",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Pz",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1P2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Eta",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Phi",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Charge",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Chi2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk1Ndof",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Pt",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Px",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Py",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Pz",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2P2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Eta",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Phi",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Charge",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Chi2",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTk2Ndof",1);
    fChain->SetBranchStatus("muonTkPairPF2PATTkVtxDcaPreFit",1);
    fChain->SetBranchStatus("metPF2PATE",1);
    fChain->SetBranchStatus("metPF2PATEt",1);
    fChain->SetBranchStatus("metPF2PATEtRaw",1);
    fChain->SetBranchStatus("metPF2PATPhi",1);
    fChain->SetBranchStatus("metPF2PATPt",1);
    fChain->SetBranchStatus("metPF2PATPx",1);
    fChain->SetBranchStatus("metPF2PATPy",1);
    fChain->SetBranchStatus("metPF2PATPz",1);
    fChain->SetBranchStatus("metPF2PATScalarEt",1);
    fChain->SetBranchStatus("metPF2PATEtUncorrected",1);
    fChain->SetBranchStatus("metPF2PATPhiUncorrected",1);
    fChain->SetBranchStatus("metPF2PATUnclusteredEnUp",1);
    fChain->SetBranchStatus("metPF2PATUnclusteredEnDown",1);
    if (isMC) {
        fChain->SetBranchStatus("genMetPF2PATE",1);
        fChain->SetBranchStatus("genMetPF2PATEt",1);
        fChain->SetBranchStatus("genMetPF2PATPhi",1);
        fChain->SetBranchStatus("genMetPF2PATPt",1);
        fChain->SetBranchStatus("genMetPF2PATPx",1);
        fChain->SetBranchStatus("genMetPF2PATPy",1);
        fChain->SetBranchStatus("genMetPF2PATPz",1);
    }
    fChain->SetBranchStatus("numPackedCands",1);
    fChain->SetBranchStatus("packedCandsPx",1);
    fChain->SetBranchStatus("packedCandsPy",1);
    fChain->SetBranchStatus("packedCandsPz",1);
    fChain->SetBranchStatus("packedCandsE",1);
    fChain->SetBranchStatus("packedCandsCharge",1);
    fChain->SetBranchStatus("packedCandsPdgId",1);
    fChain->SetBranchStatus("packedCandsTime",1);
    fChain->SetBranchStatus("packedCandsFromPV",1);
    fChain->SetBranchStatus("packedCandsPVquality",1);
    fChain->SetBranchStatus("packedCandsVx",1);
    fChain->SetBranchStatus("packedCandsVy",1);
    fChain->SetBranchStatus("packedCandsVz",1);
    fChain->SetBranchStatus("packedCandsDz",1);
    fChain->SetBranchStatus("packedCandsDxy",1);
    fChain->SetBranchStatus("packedCandsElectronIndex",1);
    fChain->SetBranchStatus("packedCandsMuonIndex",1);
    fChain->SetBranchStatus("packedCandsPhotonIndex",1);
    fChain->SetBranchStatus("packedCandsJetIndex",1);
    fChain->SetBranchStatus("packedCandsHasTrackDetails",1);
    fChain->SetBranchStatus("packedCandsDzError",1);
    fChain->SetBranchStatus("packedCandsDxyError",1);
    fChain->SetBranchStatus("packedCandsTimeError",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkPt",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkPx",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkPy",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkPz",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkEta",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkPhi",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkCharge",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkVx",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkVy",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkVz",1);
    fChain->SetBranchStatus("packedCandsPseudoTrkChi2Norm",1);
    fChain->SetBranchStatus("packedCandsHighPurityTrack",1);
    fChain->SetBranchStatus("packedCandsTrkImpactTransDist",1);
    fChain->SetBranchStatus("packedCandsTrkImpactTransError",1);
    fChain->SetBranchStatus("packedCandsTrkImpactTransSignificance",1);
    fChain->SetBranchStatus("packedCandsTrkImpact3DDist",1);
    fChain->SetBranchStatus("packedCandsTrkImpact3DError",1);
    fChain->SetBranchStatus("packedCandsTrkImpact3DSignificance",1);
    fChain->SetBranchStatus("numChsTrackPairs",1);
    fChain->SetBranchStatus("chsTkPairIndex1",1);
    fChain->SetBranchStatus("chsTkPairIndex2",1);
    fChain->SetBranchStatus("chsTkPairTkVtxPx",1);
    fChain->SetBranchStatus("chsTkPairTkVtxPy",1);
    fChain->SetBranchStatus("chsTkPairTkVtxPz",1);
    fChain->SetBranchStatus("chsTkPairTkVtxP2",1);
    fChain->SetBranchStatus("chsTkPairTkVx",1);
    fChain->SetBranchStatus("chsTkPairTkVy",1);
    fChain->SetBranchStatus("chsTkPairTkVz",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov00",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov01",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov02",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov10",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov11",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov12",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov20",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov21",1);
    fChain->SetBranchStatus("chsTkPairTkVtxCov22",1);
    fChain->SetBranchStatus("chsTkPairTkVtxChi2",1);
    fChain->SetBranchStatus("chsTkPairTkVtxNdof",1);
    fChain->SetBranchStatus("chsTkPairTkVtxTime",1);
    fChain->SetBranchStatus("chsTkPairTkVtxTimeError",1);
    fChain->SetBranchStatus("chsTkPairTkVtxAngleXY",1);
    fChain->SetBranchStatus("chsTkPairTkVtxDistMagXY",1);
    fChain->SetBranchStatus("chsTkPairTkVtxDistMagXYSigma",1);
    fChain->SetBranchStatus("chsTkPairTkVtxAngleXYZ",1);
    fChain->SetBranchStatus("chsTkPairTkVtxDistMagXYZ",1);
    fChain->SetBranchStatus("chsTkPairTkVtxDistMagXYZSigma",1);
    fChain->SetBranchStatus("chsTkPairTk1Pt",1);
    fChain->SetBranchStatus("chsTkPairTk1Px",1);
    fChain->SetBranchStatus("chsTkPairTk1Py",1);
    fChain->SetBranchStatus("chsTkPairTk1Pz",1);
    fChain->SetBranchStatus("chsTkPairTk1P2",1);
    fChain->SetBranchStatus("chsTkPairTk1Eta",1);
    fChain->SetBranchStatus("chsTkPairTk1Phi",1);
    fChain->SetBranchStatus("chsTkPairTk1Charge",1);
    fChain->SetBranchStatus("chsTkPairTk1Chi2",1);
    fChain->SetBranchStatus("chsTkPairTk1Ndof",1);
    fChain->SetBranchStatus("chsTkPairTk2Pt",1);
    fChain->SetBranchStatus("chsTkPairTk2Px",1);
    fChain->SetBranchStatus("chsTkPairTk2Py",1);
    fChain->SetBranchStatus("chsTkPairTk2Pz",1);
    fChain->SetBranchStatus("chsTkPairTk2P2",1);
    fChain->SetBranchStatus("chsTkPairTk2Eta",1);
    fChain->SetBranchStatus("chsTkPairTk2Phi",1);
    fChain->SetBranchStatus("chsTkPairTk2Charge",1);
    fChain->SetBranchStatus("chsTkPairTk2Chi2",1);
    fChain->SetBranchStatus("chsTkPairTk2Ndof",1);
    fChain->SetBranchStatus("chsTkPairTkVtxDcaPreFit",1);
    fChain->SetBranchStatus("isElePlusJets",1);
    if (isMC) {
        fChain->SetBranchStatus("genPDFScale",1);
        fChain->SetBranchStatus("genPDFx1",1);
        fChain->SetBranchStatus("genPDFx2",1);
        fChain->SetBranchStatus("genPDFf1",1);
        fChain->SetBranchStatus("genPDFf2",1);
        fChain->SetBranchStatus("topPtReweight",1);
    }
    fChain->SetBranchStatus("processId",1);
    fChain->SetBranchStatus("processPtHat",1);
    fChain->SetBranchStatus("processMCWeight",1);
    fChain->SetBranchStatus("beamSpotX",1);
    fChain->SetBranchStatus("beamSpotY",1);
    fChain->SetBranchStatus("beamSpotZ",1);
    fChain->SetBranchStatus("numPVs",1);
    fChain->SetBranchStatus("pvX",1);
    fChain->SetBranchStatus("pvY",1);
    fChain->SetBranchStatus("pvZ",1);
    fChain->SetBranchStatus("pvCov00",1);
    fChain->SetBranchStatus("pvCov01",1);
    fChain->SetBranchStatus("pvCov02",1);
    fChain->SetBranchStatus("pvCov10",1);
    fChain->SetBranchStatus("pvCov11",1);
    fChain->SetBranchStatus("pvCov12",1);
    fChain->SetBranchStatus("pvCov20",1);
    fChain->SetBranchStatus("pvCov21",1);
    fChain->SetBranchStatus("pvCov22",1);
    ...
    fChain->SetBranchStatus("pvNtracksW05",1);
    fChain->SetBranchStatus("pvTime",1);
    fChain->SetBranchStatus("pvTimeError",1);
    fChain->SetBranchStatus("numSVs",1);
    fChain->SetBranchStatus("svPt",1);
    fChain->SetBranchStatus("svPx",1);
    fChain->SetBranchStatus("svPy",1);
    fChain->SetBranchStatus("svPz",1);
    fChain->SetBranchStatus("svMass",1);
    fChain->SetBranchStatus("svE",1);
    fChain->SetBranchStatus("svEta",1);
    fChain->SetBranchStatus("svTheta",1);
    fChain->SetBranchStatus("svPhi",1);
    fChain->SetBranchStatus("svX",1);
    fChain->SetBranchStatus("svY",1);
    fChain->SetBranchStatus("svZ",1);
    fChain->SetBranchStatus("svCov00",1);
    fChain->SetBranchStatus("svCov01",1);
    fChain->SetBranchStatus("svCov02",1);
    fChain->SetBranchStatus("svCov10",1);
    fChain->SetBranchStatus("svCov11",1);
    fChain->SetBranchStatus("svCov12",1);
    fChain->SetBranchStatus("svCov20",1);
    fChain->SetBranchStatus("svCov21",1);
    fChain->SetBranchStatus("svCov22",1);
    fChain->SetBranchStatus("svVertexChi2",1);
    fChain->SetBranchStatus("svVertexNdof",1);
    fChain->SetBranchStatus("svNtracks",1);
    fChain->SetBranchStatus("svDist3D",1);
    fChain->SetBranchStatus("svDist3DSig",1);
    fChain->SetBranchStatus("svDist3DError",1);
    fChain->SetBranchStatus("svDistXY",1);
    fChain->SetBranchStatus("svDistXYSig",1);
    fChain->SetBranchStatus("svDistXYError",1);
    fChain->SetBranchStatus("svAnglePV",1);
    fChain->SetBranchStatus("svIsLambda",1);
    fChain->SetBranchStatus("svIsKshort",1);
    fChain->SetBranchStatus("mhtPt",1);
    fChain->SetBranchStatus("mhtPy",1);
    fChain->SetBranchStatus("mhtPx",1);
    fChain->SetBranchStatus("mhtPhi",1);
    fChain->SetBranchStatus("mhtSumEt",1);
    fChain->SetBranchStatus("mhtSignif",1);
    fChain->SetBranchStatus("nTriggerBits",1);
    fChain->SetBranchStatus("TriggerBits",1);
    if (isMC) {    
        fChain->SetBranchStatus("weight_muF0p5",1);
        fChain->SetBranchStatus("weight_muF2",1);
        fChain->SetBranchStatus("weight_muR0p5",1);
        fChain->SetBranchStatus("weight_muR2",1);
        fChain->SetBranchStatus("weight_muF0p5muR0p5",1);
        fChain->SetBranchStatus("weight_muF2muR2",1);
        fChain->SetBranchStatus("origWeightForNorm",1);
        fChain->SetBranchStatus("weight_pdfMax",1);
        fChain->SetBranchStatus("weight_pdfMin",1);
        fChain->SetBranchStatus("weight_alphaMax",1);
        fChain->SetBranchStatus("weight_alphaMin",1);
        fChain->SetBranchStatus("isrRedHi",1);
        fChain->SetBranchStatus("fsrRedHi",1);
        fChain->SetBranchStatus("isrRedLo",1);
        fChain->SetBranchStatus("fsrRedLo",1);
        fChain->SetBranchStatus("isrDefHi",1);
        fChain->SetBranchStatus("fsrDefHi",1);
        fChain->SetBranchStatus("isrDefLo",1);
        fChain->SetBranchStatus("fsrDefLo",1);
        fChain->SetBranchStatus("isrConHi",1);
        fChain->SetBranchStatus("fsrConHi",1);
        fChain->SetBranchStatus("isrConLo",1);
        fChain->SetBranchStatus("fsrConLo",1);
    }
    fChain->SetBranchStatus("HLT_IsoMu27_v8",1);
    fChain->SetBranchStatus("HLT_IsoMu27_v9",1);
    fChain->SetBranchStatus("HLT_IsoMu27_v10",1);
    fChain->SetBranchStatus("HLT_IsoMu27_v11",1);
    fChain->SetBranchStatus("HLT_IsoMu27_v12",1);
    fChain->SetBranchStatus("HLT_IsoMu27_v13",1);
    fChain->SetBranchStatus("HLT_IsoMu27_v14",1);
    // fChain->SetBranchStatus("HLT_IsoMu27_v",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v8",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v9",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v10",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v11",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v12",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v13",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v14",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v1",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v2",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v3",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v4",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v7",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v8",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v1",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v2",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v3",1);
    // fChain->SetBranchStatus("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v4",1);
    // fChain->SetBranchStatus("HLT_DoubleMu43NoFiltersNoVtx_v2",1);
    // fChain->SetBranchStatus("HLT_DoubleMu43NoFiltersNoVtx_v3",1);
    // fChain->SetBranchStatus("HLT_DoubleMu48NoFiltersNoVtx_v2",1);
    // fChain->SetBranchStatus("HLT_DoubleMu48NoFiltersNoVtx_v3",1);
    // fChain->SetBranchStatus("HLT_DoubleL2Mu50_v1",1);
    // fChain->SetBranchStatus("HLT_DoubleL2Mu50_v2",1);
    ...
    if (isMC) {
        fChain->SetBranchStatus("nGenPar",1);
        fChain->SetBranchStatus("genParEta",1);
        fChain->SetBranchStatus("genParPhi",1);
        fChain->SetBranchStatus("genParE",1);
        fChain->SetBranchStatus("genParPt",1);
        fChain->SetBranchStatus("genParId",1);
        fChain->SetBranchStatus("genParVx",1);
        fChain->SetBranchStatus("genParVy",1);
        fChain->SetBranchStatus("genParVz",1);
        fChain->SetBranchStatus("genParMotherId",1);
        fChain->SetBranchStatus("genParMotherIndex",1);
        fChain->SetBranchStatus("genParNumDaughters",1);
        fChain->SetBranchStatus("genParDaughterId1",1);
        fChain->SetBranchStatus("genParDaughterId2",1);
        fChain->SetBranchStatus("genParDaughter1Index",1);
        fChain->SetBranchStatus("genParDaughter2Index",1);
        fChain->SetBranchStatus("genParStatus",1);
        fChain->SetBranchStatus("genParCharge",1);
    }
    fChain->SetBranchStatus("eventRun",1);
    fChain->SetBranchStatus("eventNum",1);
    fChain->SetBranchStatus("eventLumiblock",1);
    fChain->SetBranchStatus("numVert",1);
