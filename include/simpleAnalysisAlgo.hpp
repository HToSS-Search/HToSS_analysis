...
class SimpleAnalysis 
{
    ...
    void fillPackedCandidatePlots(const AnalysisEvent& event, double& eventWeight, Float_t& Nbg1, Float_t& Nbg2, Float_t& Obs, Float_t& rate_signal, Float_t& rate_QCD, Float_t& stat_signal, Float_t& stat_QCD, const int& patMuIndex1, const int& patMuIndex2, const int& muIndex1, const int& muIndex2, const int& pionIndex1, const int& pionIndex2) const;
