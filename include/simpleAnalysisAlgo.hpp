...
class SimpleAnalysis 
{
    ...
    void fillPackedCandidatePlots(const AnalysisEvent& event, double& eventWeight, const int& patMuIndex1, const int& patMuIndex2, const int& muIndex1, const int& muIndex2, const int& pionIndex1, const int& pionIndex2) const;
